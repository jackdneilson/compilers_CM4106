...
namespace Triangle.Compiler.CodeGenerator
{
    public partial class Encoder : IDeclarationVisitor<Frame, int>
    {
        ...
        //Visitor for a constant declaration, annotates the AST if the value is unknown at compile time
        ...
        //Visitor for sequential declaration
        ...
        //Vistior for a type declaration
        ...
        //Visitor for a variable declaration, pushes to the stack and adds a new KnownAddress runtime entity to the ast
